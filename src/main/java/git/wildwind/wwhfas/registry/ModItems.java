...
public final class ModItems {
    ...
    public static final WoodItems CINDER = registerWoodItems(ModBlocks.CINDER);
    public static final WoodItems EMBER = registerWoodItems(ModBlocks.EMBER);
    ...
    private static WoodItems registerWoodItems(ModBlocks.WoodSet woodSet) {
