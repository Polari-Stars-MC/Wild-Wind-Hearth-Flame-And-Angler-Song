...
public class ModItemModelProvider extends ItemModelProvider {
	...
	protected void registerModels() {
		...
		withExistingParent("mudcrab_spawn_egg", mcLoc("item/template_spawn_egg"));
		withExistingParent("mudcrab_bucket", mcLoc("item/generated"))
				.texture("layer0", modLoc("item/mudcrab_bucket"));
		...
		basicItem(ModItems.SPIDER_COCOON.get());
	}
