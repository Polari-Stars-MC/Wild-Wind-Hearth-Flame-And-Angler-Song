...
import org.polaris2023.wild_wind.block.ModWoodType;
import org.polaris2023.wild_wind.client.screen.ArrowFletchingScreen;
import org.polaris2023.wild_wind.client.screen.inventory.tooltip.ClientOmniClawTooltip;
...
import org.polaris2023.wild_wind.registry.ModBlockEntities;
import org.polaris2023.wild_wind.registry.ModDataComponents;
import org.polaris2023.wild_wind.registry.ModMenuTypes;
...
public class ModClientHooks {
	...
	public static void onTooltip(ItemTooltipEvent event) {
		...
		addPartTooltip(event, "tooltip.wild_wind.arrow.tail", stack.get(ModDataComponents.ARROW_TAIL.get()));
		addPartTooltip(event, "tooltip.wild_wind.arrow.shaft", stack.get(ModDataComponents.ARROW_SHAFT.get()));
		addPartTooltip(event, "tooltip.wild_wind.arrow.head", stack.get(ModDataComponents.ARROW_HEAD.get()));
	}
