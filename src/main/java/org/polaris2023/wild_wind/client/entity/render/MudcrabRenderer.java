...
import org.polaris2023.wild_wind.client.entity.model.MudcrabModel;
 ...
 * 泥沼蟹实体渲染器喵~
 */
public class MudcrabRenderer extends GeoEntityRenderer<Mudcrab> {
	/**
	 * 创建泥沼蟹实体渲染器喵~
	 *
	 ...
	 */
	@Override
	public void preRender(PoseStack poseStack, Mudcrab animatable, BakedGeoModel model, @Nullable MultiBufferSource bufferSource, @Nullable VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, int colour) {
