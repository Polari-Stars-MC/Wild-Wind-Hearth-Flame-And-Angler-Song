...
import org.polaris2023.wild_wind.interaction.BlockPropertyBookFactory;
...
public final class ModCommonSetup {
	...
	private static void onRightClickBlock(PlayerInteractEvent.RightClickBlock event) {
		...
		player.displayClientMessage(Component.translatable("message.wild_wind.block_property_book.created"), true);
	...
	private static void openArrowFletchingMenu(ServerPlayer player, net.minecraft.core.BlockPos pos) {
		player.openMenu(
			new SimpleMenuProvider(
				...
				Component.translatable("container.wild_wind.arrow_fletching")
			),
			pos
		);
	}
